...
<body>
		...
		<div class="container">
			<div class="reg">
				...
				<p><h4>If you have previously registered with us, <a href="login">click here</a></p></h4>
				 ...
				 <form method="post" action="ADDUser" ModelAttribute="User">
					...
					<ul>
						...
						<li><input title="Enter First Name" path="FIRTS_NAME" name ="FIRST_NAME"  type="text" placeholder="First Name" required></li>
					</ul>
					<ul>
						<li ><b>Last Name:</b> </li>
